...
public class StringCalculatorTests {
    ...
    void moreThanTwoIntegersStringToReturnCorrectSumTest() throws NegativeNumberNotAllowedException {
    ...
    void moreThanTwoUnOrderedIntegersStringToReturnCorrectSumTest() throws NegativeNumberNotAllowedException {
    ...
    void twoIntegersWithNewLineInBetweenToReturnSumTest() throws NegativeNumberNotAllowedException {
        assertEquals(12, calculator.add("5\n7"), "String '5\\n7' should return 12");
    }

    @Test
    @DisplayName("string with two numbers with newlines in between '5\\n7\\n9,2' returns correct sum = 23")
    void moreThanTwoIntegersWithNewLineInBetweenToReturnSumTest() throws NegativeNumberNotAllowedException {
    ...
    void customDelimiterSpecifierStringWithTwoNumbersSumTest() throws NegativeNumberNotAllowedException {
        assertEquals(76, calculator.add("//|\n55|21"), "String '//|\n55|21' should return 76");
    }

    @Test
    @DisplayName("string with custom delimiter but no data '//|' returns sum = 0")
    void customDelimiterSpecifierStringWithNoNumbersSumTest() throws NegativeNumberNotAllowedException {
        assertEquals(0, calculator.add("//|"), "String '//|' should return 0");
    }

    @Test
    @DisplayName("string with custom delimiter but no data on newline '//|\\n' returns sum = 0")
    void customDelimiterSpecifierStringWithNoNumbersOnNewLineSumTest() throws NegativeNumberNotAllowedException {
        assertEquals(0, calculator.add("//|\n"), "String '//|\\n' should return 0");
    }

    @Test
    @DisplayName("string with custom delimiter and multiple numbers  '//;\\n10;3;7;5' returns sum = 25")
    void customDelimiterSpecifierStringWithMultipleNumbersSumTest() throws NegativeNumberNotAllowedException {
        assertEquals(25, calculator.add("//;\n10;3;7;5"), "String '//;\\n10;3;7;5' should return 25");
    }

    @Test
    @DisplayName("string with custom delimiter and multiple numbers  '//;\\n10.3.7.5' returns sum = 25")
    void customDelimiterSpecifierStringWithMultipleNumbersScenarioTwoSumTest() throws NegativeNumberNotAllowedException {
        assertEquals(25, calculator.add("//.\n10.3.7.5"), "String '//;\\n10.3.7.5' should return 25");
    }
